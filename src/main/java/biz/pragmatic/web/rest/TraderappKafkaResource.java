...
@RestController
@RequestMapping("/api/traderapp-kafka")
public class TraderappKafkaResource {
    private final Logger log = LoggerFactory.getLogger(TraderappKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public TraderappKafkaResource(KafkaProperties kafkaProperties) {
